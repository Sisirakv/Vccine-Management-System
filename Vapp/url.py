...
urlpatterns = [
 ...
 path('Reply/<int:id>/', Admin_View.reply_complaint, name='Reply'),
 ...
 path('mark_vaccinated/<int:id>/', Nurse_View.mark_vaccinated, name='mark_vaccinated'),
 ...
 path('Take_Appointments/<int:id>/', User_View.take_appointment, name='Take_Appointments'),
 path('Appointment', User_View.appointment, name='Appointment'),
